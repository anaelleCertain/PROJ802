...
- Sobel : Code du filtre de Sobel qui est utilisé plus tard sur l'image d'entrée et l'accumulateur. Le code est testé sur une image test.
- Affichage Sobel : Code python pour l'affichage de l'image filtrée par Sobel avec la bibliothèque matplotlib.
